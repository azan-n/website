...
#sectionBlock(
  ...
  [
    #sectionHeading(
      heading: [Live Coding Music with strudel.cc],
      location: [Bangalore, Kochi],
      role: [#link("https://azan-n.com/projects/20250924-music-at-indiafoss-with-strudelcc/")[IndiaFOSS], #link("https://azan-n.com/notes/20260228-music-at-hack4play-with-strudelcc/")[Kochi Biennale]],
      time: [2025.09, 2026.02],
    )
    Workshop on making algorithmic music using strudel.cc. I cover drum synthesis, pattern syntax, tempo control, pattern layering, genre-specific rhythmic patterns, humanization techniques, live performance, and how to use device sensors. We end with a collective jam session on the Flok collaborative platform.
  ],
)
...
#sectionBlock(
  ...
  [
    #sectionHeading(
      heading: [#link("https://github.com/kaafihai/baajit")[Baajit]],
      role: [Tauri, React],
    )
    Executive function support app for neurodivergent people. Developed at Kaafi Hai for Svayam. Licensed under MIT.
...
#sectionBlock(
  ...
  [
    #set terms(separator: [: ])
    / Programming: C\#, CSS, JavaScript, Java, Rust, Sass, SQL, TypeScript, Go
    / Software: AWS, Angular, Astro, Docker, EF Core, Figma, Node.js, Git, GitHub Actions, Grafana, Metabase, .NET Core, PostgreSQL, React, Tailwind, WordPress
  ],
)
